...
namespace kinectApp
{
    ...
    public class GestureDetector : IDisposable
    {
        ...
        public GestureDetector(KinectSensor kinectSensor, GestureResultView gestureResultView)
        {
            ...
            using (VisualGestureBuilderDatabase database = new VisualGestureBuilderDatabase(this.quitGestureDatabase))
            {
                vgbFrameSource.AddGestures(database.AvailableGestures);
            }

            using (VisualGestureBuilderDatabase database = new VisualGestureBuilderDatabase(this.handsAboveHeadGestureDatabase))
            {
                vgbFrameSource.AddGestures(database.AvailableGestures);
            }
            ...
            using (VisualGestureBuilderFrame frame = frameReference.AcquireFrame())
            {
                if (frame != null)
                {
                    ...
                    if (discreteResults != null)
                    {
                        ...
                        {
                            if (gesture.Name.Equals(this.quitGestureName) && gesture.GestureType == GestureType.Discrete)
                            {
